...
#define DEFAULT_MYSQL_HOME "/usr/local/mysql5"
#define SHAREDIR "/usr/local/mysql5/share"
#define DEFAULT_BASEDIR "/usr/local/mysql5"
#define MYSQL_DATADIR "/data/mysql"
#define DEFAULT_CHARSET_HOME "/usr/local/mysql5"
#define PLUGINDIR "/usr/local/mysql5/lib/plugin"
#define DEFAULT_SYSCONFDIR "/usr/local/mysql5/etc"
...
#define PACKAGE_STRING "MySQL Server 5.5.9"
